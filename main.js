...
<img
            ...
            <p class="card_description">
              ...
              Sus ojos son grandes y las orejas resultan largas y en punta.</p>
              </li>`;

              document.querySelector (".js-list").innerHTML = kittenOne + kittenTwo + kittenThree;

const menuAdd =document.querySelector(".js-btn-add");
const formAdd =document.querySelector(".js-btn-add");


menuAdd.addEventListener("click",(event)=>{
    event.preventDefault();
    const valueinput=(input =js-btn-add .value; formAdd.innerHTML=
